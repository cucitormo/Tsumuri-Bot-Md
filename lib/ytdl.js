...
SCRAPER YTDL NEW
AUTHOR : XYZ TEAM
JANGAN HAPUS WM KONTOL !!! 
SUMBER : https://whatsapp.com/channel/0029VaRWeGo11ulNI2Vokr1z
*/
...
/*ytdlnew('https://youtube.com/watch?v=-9UEFQ90AhE').then(res => {
 console.log(res)
sock.sendMessage(m?.chat, {document: {url: res.mp3DownloadLink}, mimetype: "audio/mpeg", caption: res.title, fileName: res.title}) 
})*/